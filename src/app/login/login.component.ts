...
export class LoginComponent {
  ...
  // This method is used to call the API login method and return the action based on response. as of now API is not integrated so just checking
  login() {
